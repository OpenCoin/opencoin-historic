...
def fast_exponentiation1(a, p, n):
...
def fast_exponentiation2(a, p, n):
    """Calculates r = a^p mod n
    """
    if p == 0: 
        return 1
    if p & 1 == 0: # even
        t = fast_exponentiation2(a, p/2, n)
        up = t**2 % n
        #print up
        #return up
    else:
        t = fast_exponentiation2(a, (p-1)/2, n)
        up =  (a * (t**2 % n)) % n
        #print up
        #return up
    
    print "fast_exponentiation2", a, p, n,up
    return up
