...
>>> issuer.makeCDD(currency_identifier='http://opencent.net/OpenCent', denominations=[Fraction('1'), Fraction('2')],
...
>>> walletA.fetchMintingKey(t,denominations=[Fraction('1')])
...
>>> pub1 = issuer.createSignedMintKey(Fraction('1'), now, later, much_later)
>>> t = ClientTest(issuer.giveMintingKey)
>>> walletA.fetchMintingKey(t,denominations=[Fraction('1')])
Client <Message('HANDSHAKE',{'protocol': 'opencoin 1.0'})>
Server <Message('HANDSHAKE_ACCEPT',None)>
...
>>> walletA.coins=[coin1]
>>> walletA.sendCoins(t, target='a book', amount=Fraction('1'))
...
def generateCDD():
    ...
    from fraction import Fraction
    denomination_strings = ['1', '2', '5', '10', '20', '50', '100', '200', '500', '1000']
    denominations = [Fraction(s) for s in denomination_strings]
...
def makeMintKeys():
    ...
    mintKey0 = makeMintKey(Fraction('1'), public0, private0)

    private1 = keys512[1]
    public1 = private1.newPublicKeyPair()
    mintKey1 = makeMintKey(Fraction('2'), public1, private1)

    private2 = keys512[2]
    public2 = private2.newPublicKeyPair()
    mintKey2 = makeMintKey(Fraction('5'), public2, private2)  

    private3 = keys512[3]
    public3 = private3.newPublicKeyPair()
    mintKey3 = makeMintKey(Fraction('10'), public3, private3)  
